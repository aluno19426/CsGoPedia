    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GamerPedia.Models.AppDB>
    {
        ...
        protected override void Seed(GamerPedia.Models.AppDB context)
        {
            ...
            var ListPlayers = new List<Players> {
                ...
                new Players {Id=1, Name="Chris de Jong", Nickname="chrisJ", BirthDate="May 25, 1990 (age 28)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/NL.gif" ,Coutry="Netherlands", Hltv="https://www.hltv.org/player/2730/chrisJ", Instagram="https://www.instagram.com/chrisjcsgo_/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/2730.png",Role="In-game leader/Rifler", Team="mousesports", TotalWinnings="$288,428", VideoHighlight="https://www.youtube.com/watch?v=XqrCsQcSwsU", TeamFK=1},

                new Players {Id=2,Name="Tomáš Šťastný", Nickname="oskar", BirthDate="June 27, 1991 (age 27)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/CZ.gif" ,Coutry="Czech Republic", Hltv="https://www.hltv.org/player/798/oskar", Instagram="https://www.instagram.com/oskartommy", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/798.png",Role="AWPer", Team="mousesports", TotalWinnings="$251,764", VideoHighlight="https://www.youtube.com/watch?v=0xXO26cGQl0", TeamFK=1},

                new Players {Id=3,Name="Robin Kool",  Nickname="ropz",BirthDate="December 22, 1999 (age 18)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/EE.gif" ,Coutry="Estonia", Hltv="https://www.hltv.org/player/11816/ropz", Instagram="https://www.instagram.com/ropzicle/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/11816.png",Role="Rifler (lurker)", Team="mousesports", TotalWinnings="$198,773", VideoHighlight="https://www.youtube.com/watch?v=N4890ImohvA", TeamFK=1},

                new Players {Id=4,Name="Miikka Kemppi",  Nickname="suNny",BirthDate="August 24, 1994 (age 23)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/FI.gif" ,Coutry="Finland", Hltv="https://www.hltv.org/player/5479/suNny", Instagram="https://www.instagram.com/sunnycsgo/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/5479.png",Role="Rifler (entry fragger)", Team="mousesports", TotalWinnings="$205,826", VideoHighlight="https://www.youtube.com/watch?v=fPVN3vteCkw", TeamFK=1},


                new Players {Id=5,Name="Janusz Pogorzelski",  Nickname="Snax",BirthDate="July 5, 1993 (age 25)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/PL.gif" ,Coutry="Poland", Hltv="https://www.hltv.org/player/2553/Snax", Instagram="https://www.instagram.com/snax1337/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/2553.png",Role="Rifler/AWPer", Team="mousesports", TotalWinnings="$576,556", VideoHighlight="https://www.youtube.com/watch?v=1eADWcd2idM", TeamFK=1},

                  //List of players of team FazeClan

                new Players {Id=6, Name="Håvard Nygaard", Nickname="rain", BirthDate="August 27, 1994 (age 23)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/NO.gif" ,Coutry="Norway", Hltv="https://www.hltv.org/player/8183/rain", Instagram="https://www.instagram.com/faze_raincs/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/8183.png",Role="Rifler (entry fragger)", Team="FaZe Clan", TotalWinnings="$532,296", VideoHighlight="https://www.youtube.com/watch?v=ifdtAujldbg", TeamFK=2},

                new Players {Id=7,Name="Finn Andersen", Nickname="karrigan", BirthDate="April 14, 1990 (age 28)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/DK.gif" ,Coutry="Denmark", Hltv="https://www.hltv.org/player/429/karrigan", Instagram="https://www.instagram.com/karrigancsgo/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/429.png",Role="In-game leader/Rifler", Team="FaZe Clan", TotalWinnings="$695,992", VideoHighlight="https://www.youtube.com/watch?v=FgLGFNtFQFo", TeamFK=2},

                new Players {Id=8,Name="Nikola Kovač",  Nickname="NiKo",BirthDate="February 16, 1997 (age 21)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/BA.gif" ,Coutry="Bosnia and Herzegovina", Hltv="https://www.hltv.org/player/3741/NiKo", Instagram="https://www.instagram.com/csgoniko/?hl=pt", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/3741.png",Role="Rifler (lurker)/AWPer", Team="FaZe Clan", TotalWinnings="$522,396", VideoHighlight="hhttps://www.youtube.com/watch?v=QOuCleKrzEw", TeamFK=2},

                new Players {Id=9,Name="Ladislav Kovács",  Nickname="GuardiaN ",BirthDate="July 9, 1991 (age 27)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/SK.gif" ,Coutry="Slovakia", Hltv="https://www.hltv.org/player/2757/GuardiaN", Instagram="https://www.instagram.com/ladislav.xkovacs/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/2757.png",Role="AWPer", Team="Faze Clan", TotalWinnings="$644,396", VideoHighlight="https://www.youtube.com/watch?v=rbINtd_NjyE", TeamFK=2},

                new Players {Id=10,Name="Olof Kajbjer Gustafsson",  Nickname="olofmeister",BirthDate="January 31, 1992 (age 26)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/SE.gif" ,Coutry="Sweden", Hltv="https://www.hltv.org/player/2553/Snax", Instagram="https://www.instagram.com/olofkajbjer/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/885.png",Role="Rifler/AWPer", Team="Faze Clan", TotalWinnings="$675,598", VideoHighlight="https://www.youtube.com/watch?v=6_wLxs2wAZ8", TeamFK=2},

                //List of players of team Renegades

               new Players {Id=11,Name="Aaron Ward",  Nickname="AZR",BirthDate="October 2, 1993 (age 25)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/AU.gif" ,Coutry="Australia", Hltv="https://www.hltv.org/player/8082/AZR", Instagram="https://www.instagram.com/azr/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/8082.png",Role="In-game leader/Rifler", Team="Renegades", TotalWinnings="$119,120", VideoHighlight="https://www.youtube.com/watch?v=Lzfr8lPNuw0", TeamFK=3},

               new Players {Id=12,Name="Justin Savage",  Nickname="jks ",BirthDate="December 12, 1995 (age 22)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/AU.gif" ,Coutry="Australia", Hltv="https://www.hltv.org/player/4679/jks", Instagram="https://www.instagram.com/jks_cs/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/4679.png",Role="Rifler", Team="Renegades", TotalWinnings="$119,120", VideoHighlight="https://www.youtube.com/watch?v=ODjHNE-4A8g", TeamFK=3},

               new Players {Id=13,Name="Karlo Pivac",  Nickname="USTILO",BirthDate="August 10, 1993 (age 24)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/AU.gif" ,Coutry="Australia", Hltv="https://www.hltv.org/player/8771/USTILO", Instagram="https://www.instagram.com/ustilocsgo/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/8771.png",Role="Rifler", Team="Renegades", TotalWinnings="$119,120", VideoHighlight="https://www.youtube.com/watch?v=WWo0oYleg1c", TeamFK=3},

               new Players {Id=14,Name="Noah Francis",  Nickname="Nifty",BirthDate="November 23, 1997 (age 20)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/US.gif" ,Coutry="United States", Hltv="https://www.hltv.org/player/9069/Nifty", Instagram="https://www.instagram.com/buzzfeednifty/?hl=pt", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/9069.png",Role="AWPer/In-game leader", Team="Renegades", TotalWinnings="$88,817", VideoHighlight="https://www.youtube.com/watch?v=yLqrjB2jk74", TeamFK=3},

               new Players {Id=15,Name="Joakim Myrbostad",  Nickname="jkaem",BirthDate="February 27, 1994 (age 24)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/NO.gif" ,Coutry="Norway", Hltv="https://www.hltv.org/player/8248/jkaem", Instagram="https://www.instagram.com/jkaem23/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/8248.png",Role="Rifler (lurker)", Team="Renegades", TotalWinnings="$79,110", VideoHighlight="https://www.youtube.com/watch?v=-KhBWM-0FZk", TeamFK=3},

               // List of players of team North

               new Players {Id=16,Name="Mathias Sommer Lauridsen",  Nickname="MSL",BirthDate="December 6, 1994 (age 23)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/DK.gif" ,Coutry="Denmark", Hltv="https://www.hltv.org/player/7156/MSL", Instagram="https://www.instagram.com/mathiassommerlauridsen/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/7156.png",Role="In-game leader/Rifler (lurker)", Team="North", TotalWinnings="$296,096", VideoHighlight="https://www.youtube.com/watch?v=CbXBJ302N5Q", TeamFK=4},

               new Players {Id=17,Name="Philip Aistrup Larsen",  Nickname="aizy ",BirthDate="June 4, 1996 (age 22)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/DK.gif" ,Coutry="Denmark", Hltv="https://www.hltv.org/player/8095/aizy", Instagram="https://www.instagram.com/aizydj/?hl=pt", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/8095.png",Role="Rifler", Team="North", TotalWinnings="$234,228", VideoHighlight="https://www.youtube.com/watch?v=qATvTfPTmLo", TeamFK=4},

               new Players {Id=18,Name="Valdemar Bjørn Vangså",  Nickname="valde",BirthDate="June 12, 1995 (age 23)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/DK.gif" ,Coutry="Denmark", Hltv="https://www.hltv.org/player/9031/valde", Instagram="https://www.instagram.com/valdeCS/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/9031.png",Role="Rifler", Team="North", TotalWinnings="$146,387", VideoHighlight="https://www.youtube.com/watch?v=TUjXKVmhc_8", TeamFK=4},

               new Players {Id=19,Name="Markus Kjærbye",  Nickname="Kjaerbye",BirthDate="April 27, 1998 (age 20)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/DK.gif" ,Coutry="Denmark", Hltv="https://www.hltv.org/player/8394/Kjaerbye", Instagram="https://www.instagram.com/markuskjaerbye/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/8394.png",Role="Rifler (entry fragger)", Team="North", TotalWinnings="$508,858", VideoHighlight="https://www.youtube.com/watch?v=u8FXWfyUGls", TeamFK=4},

                new Players {Id=20,Name="Daniel Mertz",  Nickname="mertz",BirthDate="September 29, 1998 (age 19)", ImgCountry="https://static.hltv.org/images/bigflags/30x20/DK.gif" ,Coutry="Denmark", Hltv="https://www.hltv.org/player/9895/mertz", Instagram="https://www.instagram.com/mertz98/", Photo="https://static.hltv.org//images/playerprofile/bodyshot/compressed/9895.png",Role="AWPer", Team="North", TotalWinnings="$38,035", VideoHighlight="https://www.youtube.com/watch?v=7J-q58N6F48", TeamFK=4},
            };
